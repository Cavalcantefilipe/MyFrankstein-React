export const pt = {
  ...
  home: {
    ...
    available: 'aberto a vagas full-stack sênior · remoto',
    ...
    labIntro: 'destaques do laboratório — clique num card para ver a estrutura',
    labViewAll: 'ver o lab completo',
    contactTitle: 'Vamos conversar.',
    email: 'E-mail',
    resume: 'Currículo',
  },
  lab: {
    heading: 'O Laboratório',
    intro:
      'experimentos ao vivo, estudos de caso e projetos que já entreguei — clique num card para ver a estrutura por trás',
  ...
  services: {
    ...
    contactBody:
      'Estou aberto a posições full-stack sênior, remotas. Se você tem uma vaga que faz sentido, me mande uma mensagem — respondo rápido. Também sigo atendendo projetos pontuais pela minha consultoria.',
  },
  common: {
